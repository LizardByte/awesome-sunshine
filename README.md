...
- [LutrisToSunshine](https://github.com/Arbitrate3280/LutrisToSunshine) - This script allows you to create a virtual display with audio and input isolation, lists games from Lutris, Heroic and/or Bottles, adds them to Sunshine, and optionally downloads game covers from SteamGridDB.
