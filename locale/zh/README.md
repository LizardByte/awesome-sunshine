...
<div align="center">
  ...
  <h1 align="center">燦爛的陽光</h1>
  <h4 align="center">超棒的陽光腳本、工具、指南和配套軟體合集</h4>
</div>
...
- [Android](https://github.com/moonlight-stream/moonlight-android) - 官方 Android 客戶端。
...
- [QT](https://github.com/moonlight-stream/moonlight-qt) - 官方 QT 客戶端。
- [Embedded](https://github.com/moonlight-stream/moonlight-embedded) - 官方 Embedded 客戶端。

### ✴️ 第三方月光客戶端

- [UWP/Xbox (One/Series)](https://github.com/TheElixZammuto/moonlight-xbox) - UWP/Xbox (One/Series) 客戶端。
- [PS Vita](https://github.com/xyzz/vita-moonlight) - PS Vita 客戶端。
- [Nintendo Switch](https://github.com/XITRIX/Moonlight-Switch) - Nintendo Switch 客戶端。
- [Nintendo Wii U](https://github.com/GaryOderNichts/moonlight-wiiu) - Nintendo Wii U 客戶端。
- [LG webOS TV](https://github.com/mariotaku/moonlight-tv) - LG webOS TV 客戶端。
...
- [Dummy Plug Automation](https://github.com/XenHat/dummy-plug-automation) - 在 Linux 上使用假插頭進行遠端串流的自動化。
...
- [MonitorSwapAutomation](https://github.com/Nonary/MonitorSwapAutomation) - 串流時自動切換至假插頭。
...
- [LizardByte docs](https://docs.lizardbyte.dev/projects/sunshine) - 陽光的官方文件。
- [Dummy Plug Recommendations](https://github.com/Nonary/documentation/wiki/DummyPlugs) - 在 Windows 主機上為 Sunshine 設定假插頭和虛擬顯示器的指南。
