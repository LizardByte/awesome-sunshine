...
[
  ...
  <a href="#-инструменти">Инструменти</a> •
...
- [Samsung Tizen TV](https://github.com/brightcraft/moonlight-tizen) – Клиент на Moonlight за телевизори Samsung с операционна система Tizen.
...
- [HardwareTester/GamepadTester](https://hardwaretester.com/gamepad) — Този инструмент показва текущото състояние на свързаните контролери с техните, бутони, джойстици и всичко останало, което може да бъде отчетено от програмния интерфейс за контролери на HTML5.
